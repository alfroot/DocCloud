                ...
                <div class="tab-pane active" id="home" role="tabpanel">
                    <div class="card-body">
                        <div class="profiletimeline">
                            <div class="sl-item">
                                ...
                                <div class="sl-right">
                                    <div><a href="#" class="link">Michael Qin</a> <span class="sl-date">5 minutes ago</span>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="/ElaAdmin/images/typesdoc/doc-large.png" class="img-thumbnail radius" width="150px" height="100px"/></div>
                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="/ElaAdmin/images/typesdoc/pdf-large.png" class="img-thumbnail radius" width="150px" height="100px" /></div>
                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="/ElaAdmin/images/typesdoc/ppt-large.png" class="img-thumbnail radius" width="150px" height="100px"/></div>
                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="/ElaAdmin/images/typesdoc/xls-large.png" class="img-thumbnail radius" width="150px" height="100px"/></div>
                                        </div>
                            ...
                            <hr>
                            <div class="sl-item">
                                <div class="sl-left"> <img src="/ElaAdmin/images/users/avatar-2.jpg" alt="user" class="img-circle" /> </div>
                                <div class="sl-right">
                                    <div> <a href="#" class="link">Michael Qin</a> <span class="sl-date">5 minutes ago</span>
                                        <div class="m-t-20 row">
                                            <div class="col-md-3 col-xs-12"><img src="/ElaAdmin/images/typesdoc/odt-large.png" alt="user" class="img-thumbnail radius" width="150px" height="100px/></div>
                            ...
                            <hr>
                            <div class="sl-item">
                                <div class="sl-left"> <img src="/ElaAdmin/images/users/avatar-3.jpg" alt="user" class="img-circle" /> </div>
                                <div class="sl-right">
                                    <div><a href="#" class="link">Michael Qin</a> <span class="sl-date">5 minutes ago</span>
                            ...
                            <hr>
                            <div class="sl-item">
                                <div class="sl-left"> <img src="/ElaAdmin/images/users/avatar-4.jpg" alt="user" class="img-circle" /> </div>
                                <div class="sl-right">
                                    <div><a href="#" class="link">Michael Qin</a> <span class="sl-date">5 minutes ago</span>
