                        ...
                        <table id="users-table" class="table table-hover">
                            ...
                            @foreach($messages as $message)
                                <tr id="filter_global">
                                    ...
                                    <td class="mailbox-star global_filter" id="global_filter"><a href="#"><i class="{{ $message->read === 0 ? 'fa fa-square-o'  : 'fa fa-check-square-o' }}"></i></a></td>

                                    <td id="global_filter" class="mailbox-name global_filter"><a href="{{route('readmsg' , [$message->id,$message->from] )}}">{{$message->user->name}}</a></td>
